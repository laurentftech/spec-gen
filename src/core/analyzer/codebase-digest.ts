/**
 * Codebase Digest — generates .spec-gen/CODEBASE.md
 *
 * A compact, agent-readable Markdown summary of the codebase produced by
 * `spec-gen analyze`.  Designed to be included in CLAUDE.md / .clinerules
...
interface DigestOptions {
  ...
  rootPath: string;
  /** Absolute path to the .spec-gen/analysis/ output directory */
  outputDir: string;
...
/**
 * Generate `.spec-gen/CODEBASE.md` from cached analysis artifacts.
 *
...
export async function generateCodebaseDigest(
  ...
  try {
    ...
    lines.push(`> Generated by spec-gen analyze on ${now}. Re-run after significant refactors.`);
    ...
    // ── MCP tool hints ────────────────────────────────────────────────────────
    lines.push('## When to use spec-gen MCP tools');
    lines.push('');
